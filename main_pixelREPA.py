...
import copy
from engine_pixelREPA import train_one_epoch, evaluate

from denoiser_pixelREPA import Denoiser
...
def get_args_parser():
    ...
    parser.add_argument('--mta', default='MTA-B/16', type=str)
    parser.add_argument('--img_size', default=256, type=int, help='Image size')
    parser.add_argument('--attn_dropout', type=float, default=0.0, help='Attention dropout rate')
    parser.add_argument('--proj_dropout', type=float, default=0.0, help='Projection dropout rate')
    parser.add_argument('--patch_mask_ratio', type=float, default=0.2)
    ...
    parser.add_argument('--repa_model', default="vit_base_patch14_dinov2.lvd142m")
    parser.add_argument('--repa_image_size', default=256, type=int)
    parser.add_argument('--repa_patch_size', default=16, type=int)
...
def main(args):
    ...
    if checkpoint_path and os.path.exists(checkpoint_path):
        ...
        ema_params1 = []
        for name, _ in model_without_ddp.net.named_parameters():
            ema_params1.append(ema_state_dict1[name].cuda())
        model_without_ddp.ema_params1 = ema_params1

        ema_params2 = []
        for name, _ in model_without_ddp.net.named_parameters():
            ema_params2.append(ema_state_dict2[name].cuda())
        model_without_ddp.ema_params2 = ema_params2
        ...
        model_without_ddp.ema_params1 = copy.deepcopy(list(model_without_ddp.net.parameters()))
        model_without_ddp.ema_params2 = copy.deepcopy(list(model_without_ddp.net.parameters()))
